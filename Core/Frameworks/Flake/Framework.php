...
class Framework extends \Flake\Core\Framework
{
    ...
    public static function rmQuery($sString)
    {
        ...
        return (false === $iStart) ? $sString : substr($sString, 0, $iStart);
    }
    ...
    public static function endsWith($sString, $sTest)
    {
        ...
        return 0 === substr_compare($sString, $sTest, -$iTestLen);
    }
    ...
    public static function bootstrap()
    {
        ...
        if (array_key_exists('SERVER_NAME', $_SERVER) && 'mongoose' === $_SERVER['SERVER_NAME']) {
